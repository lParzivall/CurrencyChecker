package ru.parshin.currencychecker.controller;
...
import ru.parshin.currencychecker.api.CurrencyController;
...
public class CurrencyControllerTest {
    ...
    public void whenReturnListOfCharCodes() throws Exception {
        ...
        mockMvc.perform(get("/api/v1/currency-checker/codes")
    ...
    public void whenReturnRichGif() throws Exception {
        ...
        mockMvc.perform(get("/api/v1/currency-checker/gif/TESTCODE")
                .contentType(MediaType.APPLICATION_JSON))
                .andDo(print())
